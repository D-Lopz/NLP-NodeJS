...
const REDIRECCION = { estudiante: "/estudiante", docente: "/docente", administrativo: "/admin", administrador: "/admin" };
        ...
        {!rolSeleccionado ? (
          <div>
            ...
            <div className="flex flex-col gap-2">
              {ROLES.map((r) => (
                <button key={r.value} onClick={() => setRolSeleccionado(r.value)}
          ...
          <div className="rounded-2xl border border-white/10 p-6" style={{ background: "rgba(255,255,255,0.03)" }}>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                ...
                <input type="email" value={form.email} placeholder="correo@universidad.edu"
              ...
              <div>
                ...
                <input type="password" value={form.contrasena} placeholder="••••••••"
