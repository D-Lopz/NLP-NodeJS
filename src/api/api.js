...
export const getProgramas             = ()      => request("/api/programas");
export const crearPrograma            = (data)  => request("/api/save-programa", { method: "POST", body: JSON.stringify(data) });
export const actualizarPrograma       = (id, d) => request(`/api/edit-programa/${id}`, { method: "PUT", body: JSON.stringify(d) });
export const eliminarPrograma         = (id)    => request(`/api/delete-programa/${id}`, { method: "DELETE" });
